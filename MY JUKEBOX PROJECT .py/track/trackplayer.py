...
class ModernJukeBox:
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title(" My Music Box")
        self.root.geometry("750x400")
        self.root.configure(bg="#1E1E1E")  #theme background
    ...
    def setup_styles(self):
        self.style = ttk.Style()
         ...
         # theme colors
        self.primary_color = "#9750ab"     # background back
        self.secondary_color = "#210513"          # second backround color 
        self.accent_color = "#0078D4"      #  accent color
